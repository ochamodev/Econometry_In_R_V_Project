...
trainfeatures <- datos_limpios %>% select(median_income,latitude,longitude, total_rooms, housing_median_age,-median_house_value)
trainTarget <- datos_limpios$median_house_value
testFeatures <- copyTestData %>% select(median_income,latitude,longitude, total_rooms, housing_median_age)
